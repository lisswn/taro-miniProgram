...
var redux = require("../../redux/lib/redux.js");
var createSagaMiddleware = require("../../redux-saga/lib/index.js");
var createSagaMiddleware__default = _interopDefault(createSagaMiddleware);
var invariant = _interopDefault(require("../../invariant/invariant.js"));
var isPlainObject = _interopDefault(require("../../is-plain-object/index.js"));
var warning = _interopDefault(require("../npm/warning/warning.js"));
var flatten = _interopDefault(require("../../flatten/index.js"));
var win = _interopDefault(require("../../global/window.js"));
...
function createStore(_ref) {
  ...
  var composeEnhancers = win.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? win.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
    trace: true,
    maxAge: 30
  }) : redux.compose;
  var enhancers = [redux.applyMiddleware.apply(undefined, _toConsumableArray(middlewares))].concat(_toConsumableArray(extraEnhancers));
  return redux.createStore(reducers, initialState, composeEnhancers.apply(undefined, _toConsumableArray(enhancers)));
}
    ...
    return regeneratorRuntime.wrap(function sagaWithCatch$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 5:
            _context4.next = 7;
            return effect.apply(undefined, _toConsumableArray(args.concat(createEffects(model, opts))));
